...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (title != nil) {
        ...
        if ([title respondsToSelector:@selector(boundingRectWithSize:options:attributes:context:)])
        {
            ...
            expectedSizeTitle.size = [title sizeWithFont:titleLabel.font constrainedToSize:maxSizeTitle lineBreakMode:titleLabel.lineBreakMode];
        }
    ...
    if (message != nil) {
        ...
        CGRect expectedSizeMessage;
        
        if ([title respondsToSelector:@selector(boundingRectWithSize:options:attributes:context:)])
        {
            expectedSizeMessage = [message boundingRectWithSize:maxSizeMessage
                                                    options:NSStringDrawingUsesLineFragmentOrigin
            ...
            expectedSizeMessage.size = [message sizeWithFont:messageLabel.font constrainedToSize:maxSizeMessage lineBreakMode:messageLabel.lineBreakMode];
        }
