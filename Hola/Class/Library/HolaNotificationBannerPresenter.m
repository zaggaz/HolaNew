#import "HolaNotificationBannerPresenter.h"
...
@implementation HolaNotificationBannerPresenterStyle

- (id) init {
    if (self = [super init]) {
        self.bannerMaxWidth = 350.0;
        self.bannerHeight = 35.0;
    }
...
//    banner.backgroundColor = [UIColor colorWithRed:0.808 green:0.686 blue:0.51 alpha:1];
    banner.titleLabel.textColor = [UIColor colorWithRed:0.984 green:0.42 blue:0.38 alpha:1];
