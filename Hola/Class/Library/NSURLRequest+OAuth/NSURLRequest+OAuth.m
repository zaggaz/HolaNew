...
static NSString * const kConsumerKey       = @"VGcAIUq-aE6zzvk4fVQr7w";
static NSString * const kConsumerSecret    = @"TLTjOOrzrHW27AE_zmupFmudzQY";
static NSString * const kToken             = @"2ixwJolo9CjKZHlEAzdLTEalW2TVLOJl";
static NSString * const kTokenSecret       = @"8TbZ1irxL0YcnRc-WYot85C3_VU";
