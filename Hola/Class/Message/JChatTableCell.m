...
#define MESSAGEBOUNDARY CGSizeMake(200.0, 10000.0)
...
//    return;
    ...
    if ([info.mUserId isEqualToString:[Engine gPersonInfo].mUserId])
    {
        ...
        mImgMessageBg.image = [[UIImage imageNamed:@"bubbleRight.png"] resizableImageWithCapInsets:UIEdgeInsetsMake(18, 20, 18, 25)];
        ...
        else
        {
            ...
            mImgSharedPhoto.layer.masksToBounds=YES;
             [mImgSharedPhoto setImageWithURL:[NSURL URLWithString:info.mFileUrl] placeholderImage:[UIImage imageNamed:@"bgLightGray.png"]];
            mImgMessageBg.image = [[UIImage imageNamed:@"bubbleLeft1.png"] resizableImageWithCapInsets:UIEdgeInsetsMake(18, 20, 18, 25)];
            
        }
        mImgMessageBg.image = [[UIImage imageNamed:@"bubbleLeft1.png"] resizableImageWithCapInsets:UIEdgeInsetsMake(18, 25, 18, 20)];
        [mPhotoView setContentMode:UIViewContentModeScaleAspectFill];
